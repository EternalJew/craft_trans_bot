...
Ключові правила:
- Число в кружечку — НАРОСТАЮЧИЙ ПІДСУМОК пасажирів за день, а не кількість у цьому рядку. Тому числа СТРИБАЮТЬ: 1, 2, 5, 6, 10 — рядок із «5» після «2» означає трьох пасажирів. Це НЕ помилка і НЕ нумерація рядків. Ніколи не «вирівнюй» їх у 1, 2, 3, 4 — переписуй рівно ту цифру, що намальована в кружечку, навіть якщо вона здається дивною. Різницю порахує програма.
...
- Число в кружечку — найважливіше поле, і його часто виправляють поверх. Читай кожне як окрему картинку, не як член послідовності. Придивись до кожного окремо: підсумки в незакреслених рядках лише зростають, тому якщо число менше за попереднє — перечитай обидва.
...
FREQUENT_CITIES = [
    ...
    "Клевань", "Малі Сади", "Степань", "Березне", "Володимирець", "Корець", "Гоща", "Млинів", "Демидівка",
